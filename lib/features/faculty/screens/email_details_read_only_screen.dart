...
// class EmailDetailsReadOnlyScreen extends StatefulWidget {
//   final Map<String, dynamic> request;
//   final VoidCallback onRemove;

//   const EmailDetailsReadOnlyScreen({
//     super.key,
...
//   _EmailDetailsReadOnlyScreenState createState() =>
//       _EmailDetailsReadOnlyScreenState();
// }

// class _EmailDetailsReadOnlyScreenState
//     extends State<EmailDetailsReadOnlyScreen> {
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: AppBar(
...
//                             .pop(); // Close detail page after removal
//                       },
...
class _EmailDetailsReadOnlyScreenState
    extends State<EmailDetailsReadOnlyScreen> {
  void _deleteEmailRequest() async {
    final emailRequestId = widget.request['id']; // Ensure the ID exists
    ...
    if (emailRequestId != null) {
      try {
        ...
        widget.onRemove(); // Notify parent to update UI
